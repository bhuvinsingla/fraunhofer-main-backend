...
def _serialize_result(result, job_id: str) -> dict:
    ...
    data["files"] = {
        ...
        "method1_approach3_projected_tip": f"{base}/{stem}_method1_approach3_projected_tip.png",
        "method1_approach3_inscribed_angle": f"{base}/{stem}_method1_approach3_inscribed_angle.png",
        "method1_approach3_d_r_reference": f"{base}/{stem}_method1_approach3_d_r_reference.png",
